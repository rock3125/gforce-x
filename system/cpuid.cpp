...
bool CPU::_os_support(int feature) 
{ 
	__try 
	{ 
	switch (feature) 
...
void CPU::map_mname(int family, int model, const char *v_name, char *m_name) 
{ 
...
bool CPU::CPUSupported()
{
	return _os_support(_CPU_FEATURE_SSE);
}
