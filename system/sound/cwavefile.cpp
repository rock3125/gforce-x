...
void ConverStringToWide(WCHAR* wFileName, const TCHAR* strFileName,size_t)
{
#ifndef UNICODE
...
HRESULT CWaveFile::Open(const char* strFileName,WAVEFORMATEX* pwfx,DWORD dwFlags)
{
	...
	strcpy_s(_strFileName, 1024, strFileName);
    ...
    if (m_dwFlags==WAVEFILE_READ)
    {
        ...
        m_hmmio = mmioOpen(_strFileName,NULL,MMIO_ALLOCBUF|MMIO_READ);
    ...
    {
        m_hmmio = mmioOpen(_strFileName,NULL,MMIO_ALLOCBUF |MMIO_READWRITE|MMIO_CREATE);
        if( NULL == m_hmmio )
            return E_FAIL;
...
bool CWaveFile::AtEOF(void)
{
	return (m_ck.cksize==0);
};
